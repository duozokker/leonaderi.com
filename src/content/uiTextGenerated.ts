...
export const GENERATED_UI_TEXT_OVERRIDES: Record<string, string> = {
  ...
  "intro.body": "Du spawnst als Charakter in einer Pixel-Stadt.",
  ...
  "intro.mobileInteract": "Mit Interact unten rechts sprichst du mit NPCs",
  ...
  "scene.hint.default": "Folge den Wegen und druecke E / Enter / Space.",
